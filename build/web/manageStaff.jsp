    ...
    <body>
        ...
        <div class="tab-head ">
            <nav class="nav-sidebar">
                <ul class="nav tabs ">
                    <li class="active"><a href="#tab1" data-toggle="tab">Danh sách nhân viên</a></li>
                    <li class=""><a href="#tab2" data-toggle="tab">Thêm nhân viên mới</a></li> 
                </ul>
            </nav>
            <div class=" tab-content tab-content-t ">
                    ...
                    <div class="con-w3l">
                        <table class="styled-table">
                            <tr class="row">
                                ...
                                <th class="t-head col-md-1"style="background-color: #3498db; color: #fff;">Admin</th>
                                <th class="t-head col-md-1"style="background-color: #3498db; color: #fff;">ID</th>
                                <th class="t-head col-md-2"style="background-color: #3498db; color: #fff;">Tên Admin</th>
                                <th class="t-head col-md-2"style="background-color: #3498db; color: #fff;">Email</th>
                                ...
                                <th class="t-head col-md-3"style="background-color: #3498db; color: #fff;">Tùy chọn</th>
                            </tr>

                            <c:forEach items="${requestScope.listStaff}" var="lc" varStatus="status"> 
                                <tr class="cross2 row">
                                    ...
                                    <td class="t-data col-3">
                                        <div class="col-md-6">
                                            <div> 
                                                <a href="updateStaff?aid=${lc.id}"><button class="btn btn-success"><h4>Sửa</h4></button></a>                                                      
                                            </div>
                                        </div>                                            
                                        <div class="col-md-6">
                                            <div> 
                                        ...
                                        <script>
                                            function confirmDelete(id) {
                                                var result = confirm("Có chắc chắn muốn xóa admin này? Admin sẽ không thể xóa nếu tồn tại trong đơn hàng đang mua.");
                                                if (result) {
                                                    window.location = "<%=request.getContextPath()%>/deleteStaff?aid=" + id;
                                                }
                                            }
                                        </script>
                                    </td>
                ...
                <div class="tab-pane  text-style" id="tab2">    
                    <div class="styled-table_1">
                        <div class="col-md-12">
                            <form id="updateForm" action="updateStaff" method="post">
