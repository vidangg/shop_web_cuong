        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="head-t">
                        <ul class="card">
                            <li><a href="#" onclick="showMessage()"><i  class="fa fa-shopping-cart" aria-hidden="true"></i>Giỏ hàng</a></li>
            ...
            <div class="nav-top">
                ...
                <div class="cart" >					
                    <a href="#" onclick="showMessage()"><span class="fa fa-shopping-cart my-cart-icon"><span class="badge badge-notify my-cart-badge">${size}</span></span></a>
                </div>
                <div class="clearfix"></div>
            </div>
