...
public class ViewOrderDetailsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Book> listBook = bd.getAll();
        // Gọi DAO để lấy danh sách OrderItems của đơn hàng orderId
        OrderItemsDAO oid = new OrderItemsDAO();
        List<OrderItems> listOI = oid.getByOrderId(orderId);

        request.setAttribute("listBook", listBook);
        // Set danh sách OrderItems vào request để chuyển đến JSP
        request.setAttribute("listOrderItems", listOI);
